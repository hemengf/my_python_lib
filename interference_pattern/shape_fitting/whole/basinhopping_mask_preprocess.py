...
if __name__ == "__main__":
    ...
    mask_img = cv2.imread('mask.tif', 0)
    ...
    #    for xx in range(0,1,dxx):#xx,yy starting upper left corner of patch
            ...
            if white_percentage < 0.3:
                goodness[(int(yy/dyy),int(xx/dxx))] = 1000/white_percentage
                continue
            ...
            else: #if no touching tiles are detected
                if abquadrant == 1:
            ...
            while 1:
                ...
                if result.fun <threshold:
                    ...
                    #    xopt = initcoeff_extend
                    #    break
            goodness[(int(yy/dyy),int(xx/dxx))] = resultopt
